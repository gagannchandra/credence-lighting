      ...
      <div className="relative z-10 max-w-[1600px] mx-auto px-6 md:px-16 pt-24 pb-16">
        ...
        <FadeUp delay={0} className="mb-24 flex flex-col items-center text-center">
          ...
          <h3 className="text-fluid-h1 font-serif flex flex-wrap justify-center gap-2 mb-8">
            ...
            <TextReveal text="With Elegance" delay={2} className="italic text-white/50 font-light" />
          </h3>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 border-t border-white/5 pt-16">
          ...
          <FadeUp delay={2}>
            ...
            <p className="uppercase tracking-[0.1em] text-xs text-white mb-6 font-medium">
              Navigation
            </p>
